			...
			<input type="hidden" name="memberId" value="<%=mDTO.getMember_id() %>">
				<table style="height: 200px; width: 200px;">
					...
					<tr>
						...
						<td>
						남 : <input type="radio" name="gender" value="0" required="required" <%="0".equals(mDTO.getGender())? "checked" : null %> />
						여 : <input type="radio" name="gender" value="1" required="required" <%="0".equals(mDTO.getGender())? null : "checked" %> />
						</td>
					</tr>
				</table>
